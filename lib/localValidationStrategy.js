...
function PredixLocalJWTStrategy(options, verify) {
    ...
    this.name = 'predix-local-jwt';
    this._issuer = options.issuer;
    this._verify = verify;
}

util.inherits(PredixLocalJWTStrategy, Strategy);

PredixLocalJWTStrategy.prototype.authenticate = function (req, options) {
...
module.exports = PredixLocalJWTStrategy;